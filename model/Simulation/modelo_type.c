...
#ifdef __cplusplus
  #ifdef pSimarray_float32_2VTable_defined
    extern struct SimTypeVTable *pSimarray_float32_2VTable;
  #else 
    struct SimTypeVTable *pSimarray_float32_2VTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimarray_float32_2VTable;
#endif

int array_float32_2_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimarray_float32_2VTable != NULL
        && pSimarray_float32_2VTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimarray_float32_2VTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnArrayToString(pValue, kcg_float32_to_string, 2, sizeof(kcg_float32), pfnStrAppend, pStrObj);
}

int check_array_float32_2_string(const char *str, char **endptr)
{
    static array_float32_2 rTemp;
    return string_to_array_float32_2(str, &rTemp, endptr);
}

int string_to_array_float32_2(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimarray_float32_2VTable != NULL) {
        nRet = string_to_VTable(str, pSimarray_float32_2VTable, pValue, endptr);
    }
    if (nRet == 0) {
        nRet = pConverter->m_pfnStringToArray(str, pValue, &_Type_kcg_float32_Utils, 2, sizeof(kcg_float32), endptr);
    }
    return nRet;
}

int is_array_float32_2_double_conversion_allowed()
{
    if (pSimarray_float32_2VTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimarray_float32_2VTable);
    }
    return 0;
}

int array_float32_2_to_double(const void *pValue, double *nValue)
{
    if (pSimarray_float32_2VTable != NULL) {
        return VTable_to_double(pValue, pSimarray_float32_2VTable, nValue);
    }
    return 0;
}

int is_array_float32_2_long_conversion_allowed()
{
    if (pSimarray_float32_2VTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimarray_float32_2VTable);
    }
    return 0;
}

int array_float32_2_to_long(const void *pValue, long *nValue)
{
    if (pSimarray_float32_2VTable != NULL) {
        return VTable_to_long(pValue, pSimarray_float32_2VTable, nValue);
    }
    return 0;
}

void compare_array_float32_2(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimarray_float32_2VTable != NULL
        && pSimarray_float32_2VTable->m_version >= Scv612
        && pSimarray_float32_2VTable->m_pfnCompare != NULL) {
        if (pSimarray_float32_2VTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimarray_float32_2VTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimarray_float32_2VTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        pConverter->m_pfnArrayComparison(pResult, pValue1, pValue2, 
                compare_kcg_float32, 2, sizeof(kcg_float32), pTol, pszPath, pfnStrListAppend, pListErrPaths);
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_array_float32_2_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetArraySignature(get_kcg_float32_signature, 2, pfnStrAppend, pStrObj); 
}

int init_array_float32_2(void *pValue)
{
    size_t i;
    for (i = 0; i < 2; i++)
        init_kcg_float32(&((kcg_float32*)pValue)[i]);
    return 1;
}

int release_array_float32_2(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_array_float32_2(void *pToValue, const void *pFromValue)
{
    kcg_copy_array_float32_2((array_float32_2*)pToValue, (array_float32_2*)pFromValue);
    return 1;
}

SimTypeUtils _Type_array_float32_2_Utils = {
    array_float32_2_to_string,
    check_array_float32_2_string,
    string_to_array_float32_2,
    is_array_float32_2_double_conversion_allowed,
    array_float32_2_to_double,
    is_array_float32_2_long_conversion_allowed,
    array_float32_2_to_long,
    compare_array_float32_2,
    get_array_float32_2_signature,
    init_array_float32_2,
    release_array_float32_2,
    copy_array_float32_2,
    sizeof(array_float32_2)
};
...
#ifdef __cplusplus
  #ifdef pSimarray_float32_2_8VTable_defined
    extern struct SimTypeVTable *pSimarray_float32_2_8VTable;
  #else 
    struct SimTypeVTable *pSimarray_float32_2_8VTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimarray_float32_2_8VTable;
#endif

int array_float32_2_8_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimarray_float32_2_8VTable != NULL
        && pSimarray_float32_2_8VTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimarray_float32_2_8VTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnArrayToString(pValue, array_float32_2_to_string, 8, sizeof(array_float32_2), pfnStrAppend, pStrObj);
}

int check_array_float32_2_8_string(const char *str, char **endptr)
{
    static array_float32_2_8 rTemp;
    return string_to_array_float32_2_8(str, &rTemp, endptr);
}

int string_to_array_float32_2_8(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimarray_float32_2_8VTable != NULL) {
        nRet = string_to_VTable(str, pSimarray_float32_2_8VTable, pValue, endptr);
    }
    if (nRet == 0) {
        nRet = pConverter->m_pfnStringToArray(str, pValue, &_Type_array_float32_2_Utils, 8, sizeof(array_float32_2), endptr);
    }
    return nRet;
}

int is_array_float32_2_8_double_conversion_allowed()
{
    if (pSimarray_float32_2_8VTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimarray_float32_2_8VTable);
    }
    return 0;
}

int array_float32_2_8_to_double(const void *pValue, double *nValue)
{
    if (pSimarray_float32_2_8VTable != NULL) {
        return VTable_to_double(pValue, pSimarray_float32_2_8VTable, nValue);
    }
    return 0;
}

int is_array_float32_2_8_long_conversion_allowed()
{
    if (pSimarray_float32_2_8VTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimarray_float32_2_8VTable);
    }
    return 0;
}

int array_float32_2_8_to_long(const void *pValue, long *nValue)
{
    if (pSimarray_float32_2_8VTable != NULL) {
        return VTable_to_long(pValue, pSimarray_float32_2_8VTable, nValue);
    }
    return 0;
}

void compare_array_float32_2_8(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimarray_float32_2_8VTable != NULL
        && pSimarray_float32_2_8VTable->m_version >= Scv612
        && pSimarray_float32_2_8VTable->m_pfnCompare != NULL) {
        if (pSimarray_float32_2_8VTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimarray_float32_2_8VTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimarray_float32_2_8VTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        pConverter->m_pfnArrayComparison(pResult, pValue1, pValue2, 
                compare_array_float32_2, 8, sizeof(array_float32_2), pTol, pszPath, pfnStrListAppend, pListErrPaths);
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_array_float32_2_8_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetArraySignature(get_array_float32_2_signature, 8, pfnStrAppend, pStrObj); 
}

int init_array_float32_2_8(void *pValue)
{
    size_t i;
    for (i = 0; i < 8; i++)
        init_array_float32_2(&((array_float32_2*)pValue)[i]);
    return 1;
}

int release_array_float32_2_8(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_array_float32_2_8(void *pToValue, const void *pFromValue)
{
    kcg_copy_array_float32_2_8((array_float32_2_8*)pToValue, (array_float32_2_8*)pFromValue);
    return 1;
}

SimTypeUtils _Type_array_float32_2_8_Utils = {
    array_float32_2_8_to_string,
    check_array_float32_2_8_string,
    string_to_array_float32_2_8,
    is_array_float32_2_8_double_conversion_allowed,
    array_float32_2_8_to_double,
    is_array_float32_2_8_long_conversion_allowed,
    array_float32_2_8_to_long,
    compare_array_float32_2_8,
    get_array_float32_2_8_signature,
    init_array_float32_2_8,
    release_array_float32_2_8,
    copy_array_float32_2_8,
    sizeof(array_float32_2_8)
};
...
#ifdef __cplusplus
  #ifdef pSimarray_float32_8VTable_defined
    extern struct SimTypeVTable *pSimarray_float32_8VTable;
  #else 
    struct SimTypeVTable *pSimarray_float32_8VTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimarray_float32_8VTable;
#endif

int array_float32_8_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimarray_float32_8VTable != NULL
        && pSimarray_float32_8VTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimarray_float32_8VTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnArrayToString(pValue, kcg_float32_to_string, 8, sizeof(kcg_float32), pfnStrAppend, pStrObj);
}

int check_array_float32_8_string(const char *str, char **endptr)
{
    static array_float32_8 rTemp;
    return string_to_array_float32_8(str, &rTemp, endptr);
}

int string_to_array_float32_8(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimarray_float32_8VTable != NULL) {
        nRet = string_to_VTable(str, pSimarray_float32_8VTable, pValue, endptr);
    }
    if (nRet == 0) {
        nRet = pConverter->m_pfnStringToArray(str, pValue, &_Type_kcg_float32_Utils, 8, sizeof(kcg_float32), endptr);
    }
    return nRet;
}

int is_array_float32_8_double_conversion_allowed()
{
    if (pSimarray_float32_8VTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimarray_float32_8VTable);
    }
    return 0;
}

int array_float32_8_to_double(const void *pValue, double *nValue)
{
    if (pSimarray_float32_8VTable != NULL) {
        return VTable_to_double(pValue, pSimarray_float32_8VTable, nValue);
    }
    return 0;
}

int is_array_float32_8_long_conversion_allowed()
{
    if (pSimarray_float32_8VTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimarray_float32_8VTable);
    }
    return 0;
}

int array_float32_8_to_long(const void *pValue, long *nValue)
{
    if (pSimarray_float32_8VTable != NULL) {
        return VTable_to_long(pValue, pSimarray_float32_8VTable, nValue);
    }
    return 0;
}

void compare_array_float32_8(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimarray_float32_8VTable != NULL
        && pSimarray_float32_8VTable->m_version >= Scv612
        && pSimarray_float32_8VTable->m_pfnCompare != NULL) {
        if (pSimarray_float32_8VTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimarray_float32_8VTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimarray_float32_8VTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        pConverter->m_pfnArrayComparison(pResult, pValue1, pValue2, 
                compare_kcg_float32, 8, sizeof(kcg_float32), pTol, pszPath, pfnStrListAppend, pListErrPaths);
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_array_float32_8_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetArraySignature(get_kcg_float32_signature, 8, pfnStrAppend, pStrObj); 
}

int init_array_float32_8(void *pValue)
{
    size_t i;
    for (i = 0; i < 8; i++)
        init_kcg_float32(&((kcg_float32*)pValue)[i]);
...
int release_array_float32_8(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_array_float32_8(void *pToValue, const void *pFromValue)
{
    kcg_copy_array_float32_8((array_float32_8*)pToValue, (array_float32_8*)pFromValue);
    return 1;
}

SimTypeUtils _Type_array_float32_8_Utils = {
    array_float32_8_to_string,
    check_array_float32_8_string,
    string_to_array_float32_8,
    is_array_float32_8_double_conversion_allowed,
    array_float32_8_to_double,
    is_array_float32_8_long_conversion_allowed,
    array_float32_8_to_long,
    compare_array_float32_8,
    get_array_float32_8_signature,
    init_array_float32_8,
    release_array_float32_8,
    copy_array_float32_8,
    sizeof(array_float32_8)
};
...
#ifdef __cplusplus
  #ifdef pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable_defined
    extern struct SimTypeVTable *pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable;
  #else 
    struct SimTypeVTable *pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable;
#endif

static SimEnumValUtils SSM_ST_regularEIngresar_inspiracion_ventilador_values[] = {
    { "regular", SSM_st_regular_regularEIngresar_inspiracion_ventilador},
    { "regular", SSM_st_regular_regularEIngresar_inspiracion_ventilador},
    { "ingresar", SSM_st_ingresar_regularEIngresar_inspiracion_ventilador},
    { "ingresar", SSM_st_ingresar_regularEIngresar_inspiracion_ventilador},
};
const int SSM_ST_regularEIngresar_inspiracion_ventilador_nb_values = 4;

int SSM_ST_regularEIngresar_inspiracion_ventilador_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable != NULL
        && pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_ST_regularEIngresar_inspiracion_ventilador*)pValue, SSM_ST_regularEIngresar_inspiracion_ventilador_values, SSM_ST_regularEIngresar_inspiracion_ventilador_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_ST_regularEIngresar_inspiracion_ventilador_string(const char *str, char **endptr)
{
    static SSM_ST_regularEIngresar_inspiracion_ventilador rTemp;
    return string_to_SSM_ST_regularEIngresar_inspiracion_ventilador(str, &rTemp, endptr);
}

int string_to_SSM_ST_regularEIngresar_inspiracion_ventilador(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_ST_regularEIngresar_inspiracion_ventilador_values, SSM_ST_regularEIngresar_inspiracion_ventilador_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_ST_regularEIngresar_inspiracion_ventilador*)pValue = (SSM_ST_regularEIngresar_inspiracion_ventilador)nTemp;
    }
    return nRet;
}

int is_SSM_ST_regularEIngresar_inspiracion_ventilador_double_conversion_allowed()
{
    if (pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable);
    }
    return 1;
}

int SSM_ST_regularEIngresar_inspiracion_ventilador_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable, nValue);
    }
    *nValue = (double)*((SSM_ST_regularEIngresar_inspiracion_ventilador*)pValue);
    return 1;
}

int is_SSM_ST_regularEIngresar_inspiracion_ventilador_long_conversion_allowed()
{
    if (pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable);
    }
    return 1;
}

int SSM_ST_regularEIngresar_inspiracion_ventilador_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable, nValue);
    }
    *nValue = (long)*((SSM_ST_regularEIngresar_inspiracion_ventilador*)pValue);
    return 1;
}

void compare_SSM_ST_regularEIngresar_inspiracion_ventilador(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable != NULL
        && pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable->m_version >= Scv612
        && pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable->m_pfnCompare != NULL) {
        if (pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_ST_regularEIngresar_inspiracion_ventiladorVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_ST_regularEIngresar_inspiracion_ventilador*)pValue1), (int)(*(SSM_ST_regularEIngresar_inspiracion_ventilador*)pValue2));
    }
    UNUSED(pTol);
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
...
int get_SSM_ST_regularEIngresar_inspiracion_ventilador_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_ST_regularEIngresar_inspiracion_ventilador_values, SSM_ST_regularEIngresar_inspiracion_ventilador_nb_values, pfnStrAppend, pStrObj);
}

int init_SSM_ST_regularEIngresar_inspiracion_ventilador(void *pValue)
{
    *(SSM_ST_regularEIngresar_inspiracion_ventilador*)pValue = SSM_st_regular_regularEIngresar_inspiracion_ventilador;
    return 1;
}

int release_SSM_ST_regularEIngresar_inspiracion_ventilador(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_SSM_ST_regularEIngresar_inspiracion_ventilador(void *pToValue, const void *pFromValue)
{
    *((SSM_ST_regularEIngresar_inspiracion_ventilador*)pToValue) = *((SSM_ST_regularEIngresar_inspiracion_ventilador*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_ST_regularEIngresar_inspiracion_ventilador_Utils = {
    SSM_ST_regularEIngresar_inspiracion_ventilador_to_string,
    check_SSM_ST_regularEIngresar_inspiracion_ventilador_string,
    string_to_SSM_ST_regularEIngresar_inspiracion_ventilador,
    is_SSM_ST_regularEIngresar_inspiracion_ventilador_double_conversion_allowed,
    SSM_ST_regularEIngresar_inspiracion_ventilador_to_double,
    is_SSM_ST_regularEIngresar_inspiracion_ventilador_long_conversion_allowed,
    SSM_ST_regularEIngresar_inspiracion_ventilador_to_long,
    compare_SSM_ST_regularEIngresar_inspiracion_ventilador,
    get_SSM_ST_regularEIngresar_inspiracion_ventilador_signature,
    init_SSM_ST_regularEIngresar_inspiracion_ventilador,
    release_SSM_ST_regularEIngresar_inspiracion_ventilador,
    copy_SSM_ST_regularEIngresar_inspiracion_ventilador,
    sizeof(SSM_ST_regularEIngresar_inspiracion_ventilador)
};
...
#ifdef __cplusplus
  #ifdef pSimSSM_ST_ventiladorVTable_defined
    extern struct SimTypeVTable *pSimSSM_ST_ventiladorVTable;
  #else 
    struct SimTypeVTable *pSimSSM_ST_ventiladorVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_ST_ventiladorVTable;
#endif

static SimEnumValUtils SSM_ST_ventilador_values[] = {
    { "inspiracion", SSM_st_inspiracion_ventilador},
    { "inspiracion", SSM_st_inspiracion_ventilador},
    { "espiracion", SSM_st_espiracion_ventilador},
    { "espiracion", SSM_st_espiracion_ventilador},
    { "pausaInspiracion", SSM_st_pausaInspiracion_ventilador},
    { "pausaInspiracion", SSM_st_pausaInspiracion_ventilador},
    { "pausaEspiracion", SSM_st_pausaEspiracion_ventilador},
    { "pausaEspiracion", SSM_st_pausaEspiracion_ventilador},
};
const int SSM_ST_ventilador_nb_values = 8;

int SSM_ST_ventilador_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_ST_ventiladorVTable != NULL
        && pSimSSM_ST_ventiladorVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_ST_ventiladorVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_ST_ventilador*)pValue, SSM_ST_ventilador_values, SSM_ST_ventilador_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_ST_ventilador_string(const char *str, char **endptr)
{
    static SSM_ST_ventilador rTemp;
    return string_to_SSM_ST_ventilador(str, &rTemp, endptr);
}

int string_to_SSM_ST_ventilador(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_ST_ventiladorVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_ST_ventiladorVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_ST_ventilador_values, SSM_ST_ventilador_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_ST_ventilador*)pValue = (SSM_ST_ventilador)nTemp;
    }
    return nRet;
}

int is_SSM_ST_ventilador_double_conversion_allowed()
{
    if (pSimSSM_ST_ventiladorVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_ST_ventiladorVTable);
    }
    return 1;
}

int SSM_ST_ventilador_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_ST_ventiladorVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_ST_ventiladorVTable, nValue);
    }
    *nValue = (double)*((SSM_ST_ventilador*)pValue);
    return 1;
}

int is_SSM_ST_ventilador_long_conversion_allowed()
{
    if (pSimSSM_ST_ventiladorVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_ST_ventiladorVTable);
    }
    return 1;
}

int SSM_ST_ventilador_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_ST_ventiladorVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_ST_ventiladorVTable, nValue);
    }
    *nValue = (long)*((SSM_ST_ventilador*)pValue);
    return 1;
}

void compare_SSM_ST_ventilador(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_ST_ventiladorVTable != NULL
        && pSimSSM_ST_ventiladorVTable->m_version >= Scv612
        && pSimSSM_ST_ventiladorVTable->m_pfnCompare != NULL) {
        if (pSimSSM_ST_ventiladorVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_ST_ventiladorVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_ST_ventiladorVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_ST_ventilador*)pValue1), (int)(*(SSM_ST_ventilador*)pValue2));
    }
    UNUSED(pTol);
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
...
int get_SSM_ST_ventilador_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_ST_ventilador_values, SSM_ST_ventilador_nb_values, pfnStrAppend, pStrObj);
}

int init_SSM_ST_ventilador(void *pValue)
{
    *(SSM_ST_ventilador*)pValue = SSM_st_inspiracion_ventilador;
    return 1;
}

int release_SSM_ST_ventilador(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_SSM_ST_ventilador(void *pToValue, const void *pFromValue)
{
    *((SSM_ST_ventilador*)pToValue) = *((SSM_ST_ventilador*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_ST_ventilador_Utils = {
    SSM_ST_ventilador_to_string,
    check_SSM_ST_ventilador_string,
    string_to_SSM_ST_ventilador,
    is_SSM_ST_ventilador_double_conversion_allowed,
    SSM_ST_ventilador_to_double,
    is_SSM_ST_ventilador_long_conversion_allowed,
    SSM_ST_ventilador_to_long,
    compare_SSM_ST_ventilador,
    get_SSM_ST_ventilador_signature,
    init_SSM_ST_ventilador,
    release_SSM_ST_ventilador,
    copy_SSM_ST_ventilador,
    sizeof(SSM_ST_ventilador)
};
...
#ifdef __cplusplus
  #ifdef pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable_defined
    extern struct SimTypeVTable *pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable;
  #else 
    struct SimTypeVTable *pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable;
#endif

static SimEnumValUtils SSM_TR_regularEIngresar_inspiracion_ventilador_values[] = {
    { "SSM_TR_no_trans_regularEIngresar_inspiracion_ventilador", SSM_TR_no_trans_regularEIngresar_inspiracion_ventilador},
    { "SSM_TR_no_trans_regularEIngresar_inspiracion_ventilador", SSM_TR_no_trans_regularEIngresar_inspiracion_ventilador},
    { "SSM_TR_regular_ingresar_1_regular_regularEIngresar_inspiracion_ventilador", SSM_TR_regular_ingresar_1_regular_regularEIngresar_inspiracion_ventilador},
    { "SSM_TR_regular_ingresar_1_regular_regularEIngresar_inspiracion_ventilador", SSM_TR_regular_ingresar_1_regular_regularEIngresar_inspiracion_ventilador},
    { "SSM_TR_ingresar_regular_1_ingresar_regularEIngresar_inspiracion_ventilador", SSM_TR_ingresar_regular_1_ingresar_regularEIngresar_inspiracion_ventilador},
    { "SSM_TR_ingresar_regular_1_ingresar_regularEIngresar_inspiracion_ventilador", SSM_TR_ingresar_regular_1_ingresar_regularEIngresar_inspiracion_ventilador},
};
const int SSM_TR_regularEIngresar_inspiracion_ventilador_nb_values = 6;

int SSM_TR_regularEIngresar_inspiracion_ventilador_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable != NULL
        && pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_TR_regularEIngresar_inspiracion_ventilador*)pValue, SSM_TR_regularEIngresar_inspiracion_ventilador_values, SSM_TR_regularEIngresar_inspiracion_ventilador_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_TR_regularEIngresar_inspiracion_ventilador_string(const char *str, char **endptr)
{
    static SSM_TR_regularEIngresar_inspiracion_ventilador rTemp;
    return string_to_SSM_TR_regularEIngresar_inspiracion_ventilador(str, &rTemp, endptr);
}

int string_to_SSM_TR_regularEIngresar_inspiracion_ventilador(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_TR_regularEIngresar_inspiracion_ventilador_values, SSM_TR_regularEIngresar_inspiracion_ventilador_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_TR_regularEIngresar_inspiracion_ventilador*)pValue = (SSM_TR_regularEIngresar_inspiracion_ventilador)nTemp;
    }
    return nRet;
}

int is_SSM_TR_regularEIngresar_inspiracion_ventilador_double_conversion_allowed()
{
    if (pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable);
    }
    return 1;
}

int SSM_TR_regularEIngresar_inspiracion_ventilador_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable, nValue);
    }
    *nValue = (double)*((SSM_TR_regularEIngresar_inspiracion_ventilador*)pValue);
    return 1;
}

int is_SSM_TR_regularEIngresar_inspiracion_ventilador_long_conversion_allowed()
{
    if (pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable);
    }
    return 1;
}

int SSM_TR_regularEIngresar_inspiracion_ventilador_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable, nValue);
    }
    *nValue = (long)*((SSM_TR_regularEIngresar_inspiracion_ventilador*)pValue);
    return 1;
}

void compare_SSM_TR_regularEIngresar_inspiracion_ventilador(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable != NULL
        && pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable->m_version >= Scv612
        && pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable->m_pfnCompare != NULL) {
        if (pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_TR_regularEIngresar_inspiracion_ventiladorVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_TR_regularEIngresar_inspiracion_ventilador*)pValue1), (int)(*(SSM_TR_regularEIngresar_inspiracion_ventilador*)pValue2));
    }
    UNUSED(pTol);
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
...
int get_SSM_TR_regularEIngresar_inspiracion_ventilador_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_TR_regularEIngresar_inspiracion_ventilador_values, SSM_TR_regularEIngresar_inspiracion_ventilador_nb_values, pfnStrAppend, pStrObj);
}

int init_SSM_TR_regularEIngresar_inspiracion_ventilador(void *pValue)
{
    *(SSM_TR_regularEIngresar_inspiracion_ventilador*)pValue = SSM_TR_no_trans_regularEIngresar_inspiracion_ventilador;
    return 1;
}

int release_SSM_TR_regularEIngresar_inspiracion_ventilador(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_SSM_TR_regularEIngresar_inspiracion_ventilador(void *pToValue, const void *pFromValue)
{
    *((SSM_TR_regularEIngresar_inspiracion_ventilador*)pToValue) = *((SSM_TR_regularEIngresar_inspiracion_ventilador*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_TR_regularEIngresar_inspiracion_ventilador_Utils = {
    SSM_TR_regularEIngresar_inspiracion_ventilador_to_string,
    check_SSM_TR_regularEIngresar_inspiracion_ventilador_string,
    string_to_SSM_TR_regularEIngresar_inspiracion_ventilador,
    is_SSM_TR_regularEIngresar_inspiracion_ventilador_double_conversion_allowed,
    SSM_TR_regularEIngresar_inspiracion_ventilador_to_double,
    is_SSM_TR_regularEIngresar_inspiracion_ventilador_long_conversion_allowed,
    SSM_TR_regularEIngresar_inspiracion_ventilador_to_long,
    compare_SSM_TR_regularEIngresar_inspiracion_ventilador,
    get_SSM_TR_regularEIngresar_inspiracion_ventilador_signature,
    init_SSM_TR_regularEIngresar_inspiracion_ventilador,
    release_SSM_TR_regularEIngresar_inspiracion_ventilador,
    copy_SSM_TR_regularEIngresar_inspiracion_ventilador,
    sizeof(SSM_TR_regularEIngresar_inspiracion_ventilador)
};
...
#ifdef __cplusplus
  #ifdef pSimSSM_TR_ventiladorVTable_defined
    extern struct SimTypeVTable *pSimSSM_TR_ventiladorVTable;
  #else 
    struct SimTypeVTable *pSimSSM_TR_ventiladorVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_TR_ventiladorVTable;
#endif

static SimEnumValUtils SSM_TR_ventilador_values[] = {
    { "SSM_TR_no_trans_ventilador", SSM_TR_no_trans_ventilador},
    { "SSM_TR_no_trans_ventilador", SSM_TR_no_trans_ventilador},
    { "SSM_TR_inspiracion_pausaInspiracion_1_inspiracion_ventilador", SSM_TR_inspiracion_pausaInspiracion_1_inspiracion_ventilador},
    { "SSM_TR_inspiracion_pausaInspiracion_1_inspiracion_ventilador", SSM_TR_inspiracion_pausaInspiracion_1_inspiracion_ventilador},
    { "SSM_TR_espiracion_pausaEspiracion_1_espiracion_ventilador", SSM_TR_espiracion_pausaEspiracion_1_espiracion_ventilador},
    { "SSM_TR_espiracion_pausaEspiracion_1_espiracion_ventilador", SSM_TR_espiracion_pausaEspiracion_1_espiracion_ventilador},
    { "SSM_TR_pausaInspiracion_espiracion_1_pausaInspiracion_ventilador", SSM_TR_pausaInspiracion_espiracion_1_pausaInspiracion_ventilador},
    { "SSM_TR_pausaInspiracion_espiracion_1_pausaInspiracion_ventilador", SSM_TR_pausaInspiracion_espiracion_1_pausaInspiracion_ventilador},
    { "SSM_TR_pausaEspiracion_inspiracion_1_pausaEspiracion_ventilador", SSM_TR_pausaEspiracion_inspiracion_1_pausaEspiracion_ventilador},
    { "SSM_TR_pausaEspiracion_inspiracion_1_pausaEspiracion_ventilador", SSM_TR_pausaEspiracion_inspiracion_1_pausaEspiracion_ventilador},
};
const int SSM_TR_ventilador_nb_values = 10;

int SSM_TR_ventilador_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_TR_ventiladorVTable != NULL
        && pSimSSM_TR_ventiladorVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_TR_ventiladorVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_TR_ventilador*)pValue, SSM_TR_ventilador_values, SSM_TR_ventilador_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_TR_ventilador_string(const char *str, char **endptr)
{
    static SSM_TR_ventilador rTemp;
    return string_to_SSM_TR_ventilador(str, &rTemp, endptr);
}

int string_to_SSM_TR_ventilador(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_TR_ventiladorVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_TR_ventiladorVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_TR_ventilador_values, SSM_TR_ventilador_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_TR_ventilador*)pValue = (SSM_TR_ventilador)nTemp;
    }
    return nRet;
}

int is_SSM_TR_ventilador_double_conversion_allowed()
{
    if (pSimSSM_TR_ventiladorVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_TR_ventiladorVTable);
    }
    return 1;
}

int SSM_TR_ventilador_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_TR_ventiladorVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_TR_ventiladorVTable, nValue);
    }
    *nValue = (double)*((SSM_TR_ventilador*)pValue);
    return 1;
}

int is_SSM_TR_ventilador_long_conversion_allowed()
{
    if (pSimSSM_TR_ventiladorVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_TR_ventiladorVTable);
    }
    return 1;
}

int SSM_TR_ventilador_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_TR_ventiladorVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_TR_ventiladorVTable, nValue);
    }
    *nValue = (long)*((SSM_TR_ventilador*)pValue);
    return 1;
}

void compare_SSM_TR_ventilador(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_TR_ventiladorVTable != NULL
        && pSimSSM_TR_ventiladorVTable->m_version >= Scv612
        && pSimSSM_TR_ventiladorVTable->m_pfnCompare != NULL) {
        if (pSimSSM_TR_ventiladorVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_TR_ventiladorVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_TR_ventiladorVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_TR_ventilador*)pValue1), (int)(*(SSM_TR_ventilador*)pValue2));
    }
    UNUSED(pTol);
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
...
int get_SSM_TR_ventilador_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_TR_ventilador_values, SSM_TR_ventilador_nb_values, pfnStrAppend, pStrObj);
}

int init_SSM_TR_ventilador(void *pValue)
{
    *(SSM_TR_ventilador*)pValue = SSM_TR_no_trans_ventilador;
    return 1;
}

int release_SSM_TR_ventilador(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_SSM_TR_ventilador(void *pToValue, const void *pFromValue)
{
    *((SSM_TR_ventilador*)pToValue) = *((SSM_TR_ventilador*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_TR_ventilador_Utils = {
    SSM_TR_ventilador_to_string,
    check_SSM_TR_ventilador_string,
    string_to_SSM_TR_ventilador,
    is_SSM_TR_ventilador_double_conversion_allowed,
    SSM_TR_ventilador_to_double,
    is_SSM_TR_ventilador_long_conversion_allowed,
    SSM_TR_ventilador_to_long,
    compare_SSM_TR_ventilador,
    get_SSM_TR_ventilador_signature,
    init_SSM_TR_ventilador,
    release_SSM_TR_ventilador,
    copy_SSM_TR_ventilador,
    sizeof(SSM_TR_ventilador)
};
